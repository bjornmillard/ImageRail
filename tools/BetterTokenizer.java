...
/*
 * @(#)BetterTokenizer.java	1.21g 99/03/04
 *
...
/**
 * The <code>BetterTokenizer</code> class takes an input stream and
...
public class BetterTokenizer
{
	 ...
	 * </ul>
	 *
	 * @see     java.io.BetterTokenizer#eolIsSignificant(boolean)
	 * @see     java.io.BetterTokenizer#nextToken()
...
////		parseNumbers();
	 ...
	 * @see        java.io.BetterTokenizer#BetterTokenizer(java.io.Reader)
	 */
	public BetterTokenizer(InputStream is)
	{
		this();
		input = is;
	}
	 ...
	 * @since   JDK1.1
	 */
	public BetterTokenizer(Reader r)
	{
		this();
		reader = r;
	}
	 ...
	 * @author WJS
	 */
	public void readArray(byte[] byteArray)
	{
		...
		{
			System.out.println("BetterTokenizer.readArray - error reading array "+ex);
		}
	...
	public int nextToken() throws IOException
	{
		...
		if ((ctype & CT_DIGIT) != 0) {	// GvonD changed to handle scientific notation
			boolean neg = false;
			boolean exp = false;	// GvonD added
			boolean negexp = false;	// GvonD added
			if (c == '-')
			{
				c = read();
				if (c != '.' && (c < '0' || c > '9'))
...
//				}
				...
				else if (seendot == 1 && (c == 'f' || c == 'F' || c == 'd' || c == 'D'))
					;	// this is here to swallow the possible trailing character correctly
				else
					break;
				c = read();
			}
